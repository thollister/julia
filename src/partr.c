...
void jl_init_threadinginfra(void)
{
    ...
    all_taskqs = (jl_ptask_t ***)_mm_malloc(jl_n_threads * sizeof(jl_ptask_t **), 64);
...
static void init_started_thread()
{
    ...
    ptls->sticky_taskq_lock = (int8_t *)_mm_malloc(sizeof(int8_t) + sizeof(jl_ptask_t *), 64);
...
void jl_threadfun(void *arg)
{
    ...
    _mm_free(ptls->sticky_taskq_lock);
}
